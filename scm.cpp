...
// Hello , My name is Devansh and I am one of the collaborators in the project of Anurag Mor
// function to modify record
// This function will modify the records that is present.
...
//Modification and addition of list() 
//It will actually display all the records along with their details
...
//Displaying the Convict code through a new function empty()
